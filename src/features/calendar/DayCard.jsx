...
const DayCard = ({ date, tasks = [] }) => {
  ...
  return (
    <div className={`flex flex-col min-h-[450px] bg-white dark:bg-gray-900 rounded-3xl border transition-all duration-300 group
      ${isCurrentDay 
      ...
      {/* Task List */}
      <div className="flex-1 px-5 space-y-3 overflow-y-auto max-h-[350px] custom-scrollbar pb-4">
